...
public class Jogador {
	...
	public void MovimentarPeca(Campo tabuleiro, int[] pos) {
		...
		// resolver aqui para adquirir várias posições possíveis
		int[] retorno = tabuleiro.getPecas()[posicoes[0]][posicoes[1]].movimentar(posicoes, getCorPeca())[0];
		System.out.println(retorno[0] + "," + retorno[1] + " - <- Tá em jogador");
		// necessidade de poder mostrar na tela o array e dps fazer o jogador digitar a
		// posição que ele
		// uqer jogar
